...
if __name__ == '__main__':
    ...
    # 路径参数
    parser.add_argument('--save-path', default='./save/cifarfs-stage3-enhanced')
    parser.add_argument('--stage1-path', default='./save/cifarfs-stage1')
    parser.add_argument('--stage2-path', default='./save/cifarfs-stage2-1s')
